    ...
    <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-px-6 tw-py-8 tw-mx-auto tw-h-screen lg:tw-py-0">
        ...
        <div class="tw-w-full tw-bg-white tw-rounded-lg tw-shadow-md md:tw-mt-0 sm:tw-max-w-md xl:tw-p-0">
            <div class="tw-p-6 tw-space-y-4 md:tw-space-y-6 sm:tw-p-8">
                ...
                <form class="tw-space-y-4 md:tw-space-y-6" method="POST" action="{{ route('password.email') }}">
                    @csrf
                    <div>
                    ...
                    <button type="submit"
                        class="tw-w-full tw-rounded-lg tw-transition-all tw-duration-200 tw-bg-indigo-600 tw-px-4 tw-py-1.5 tw-text-base tw-font-semibold tw-leading-7 tw-text-white hover:tw-text-white tw-shadow-sm tw-ring-1 tw-ring-indigo-600 hover:tw-bg-indigo-700">Send Reset Link</button>
                    <p class="tw-text-sm tw-font-light tw-text-gray-500">
                        Remeber your password? <a href="{{ route('login') }}"
